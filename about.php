    ...
    <div class="text-center mt-5">
        ...
        <div class="container text-center">
            <div class="row align-items-end">
                <div class="col">
                    <a class="" aria-current="" href="https://github.com/Coldoen/Euler"><img src="./img/GitHub_Invertocat_Logo.svg.png"></a>
                </div>
                <div class="col">
                    <a class="" aria-current="" href="https://discordapp.com/users/159404083722059777"><img src="./img/discord-logo-transparent-free-png.png"></a>
                </div>
            </div>
        </div>
    </div>
