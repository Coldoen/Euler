<?php require './template/header.php'; ?>
        ...
        <div class="container">
            <div class="text-center mt-5">
                ...
                ― Leonhard Euler</h2>
                <div class="lead">
                    <h3>A webstie hosting the first hundread problems of the Euler project solved using PHP</h3>
            ...
            <div class="col">
                    <a class="" aria-current="" href="https://projecteuler.net"><img src="">Learn more about Project Euler</a>
                </div>
                <div class="col">
                    <a class="" aria-current="" href="<?php require_once('./functions/randomProblem.php'); echo generateRandomProblemLink();?>"><img src="">Today's problem featured</a>
                </div>
            </div>
        </div>
